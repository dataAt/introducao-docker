...
<!-- Aqui são listados alguns comandos do Docker CLI [...] -->
Para facilitar a utilização do Docker, abaixo são listados alguns comandos úteis que podem ser úteis a você.
...
- Executando um container - (Interativo): `docker run -ti debian /bin/bash`
